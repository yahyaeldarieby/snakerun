...
# Forever Loop
# x = Get user input
# if(x) = Key 4 then press enter then the snake will move left
# if(x) = Key 3 then press enter then the snake will move right
# if(x) = Key 1 then press enter then the snake will move up
# if(x) = Key 2 then press enter then the snake will move down
# if(x) = Key 5 then press enter to quit the whole system
...
# If new location has a part of the snake, then the snake dies and exit the game
# End of forever loop
# End of program
...
print ("You simply just use the keys 1, 2, 3, 4 to move up, down, right and left.")
print ("# How will you win the game")
print ("You can't really win the game but you try to beat your own high score from the last game you played." )
...
print ("# System Quit")
print ("To quit the whole system press the key 5 then hit enter to quit the whole system.")
